...
void xamarin_create_classes () {
	...
	__xamarin_class_map [35].handle = objc_getClass ("AVCaptureOutput");
	__xamarin_class_map [36].handle = objc_getClass ("AVCaptureSession");
	...
	__xamarin_class_map [45].handle = objc_getClass ("AVCaptureDevice");
	__xamarin_class_map [46].handle = objc_getClass ("AVCaptureStillImageOutput");
